...
add_filter('timber/acf-gutenberg-blocks-data/certifications', function ($context) {
    $context['certifications'] = Timber::get_posts(array(
        'post_type' => 'documents',
        'posts_per_page' => -1,
        'orderby' => 'menu_order',
        'order' => 'ASC'
...
add_action('after_setup_theme', 'wd_gutenberg_editor_styles');
function wd_gutenberg_editor_styles()
{
